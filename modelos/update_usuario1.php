...
if ($id !== null && $nombre_completo !== null && $correo !== null && $usuario !== null && $Id_rol !== null && $id_estado !== null) {
    ...
    if ($stmt) {
        // Vincular parámetros
        mysqli_stmt_bind_param($stmt, "isssi", $id, $nombre_completo, $correo, $usuario, $Id_rol ,$id_estado);
