    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover">
            ...
            <tbody class="text-center">
                ...
                $sql = $conexion->query("SELECT * FROM  tbl_apoyos_produccion");
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        <td><?= $datos->id_apoyo_prod  ?></td>
                        ...
                        <td>
                            ...
                            ('<?= $datos->id_apoyo_prod  ?>', '<?= $datos->id_ficha ?>', '<?= $datos->id_productor ?>', '<?= $datos->otros_detalles ?>', '<?= $datos->descripcion ?>', '<?= $datos->estado ?>')">
...
<script>
    ...
    function abrirModalEditar(id_apoyo_prod , id_ficha, id_productor, otros_detalles, descripcion, estado) {
