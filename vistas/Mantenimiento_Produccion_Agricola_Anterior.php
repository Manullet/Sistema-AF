    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover">
            ...
            <tbody class="text-center">
                ...
                $sql = $conexion->query("SELECT * FROM tbl_Produccion_Agricola_Anterior");
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ('<?= $datos->Id_Produccion_Anterior ?>', '<?= $datos->Precio_Venta ?>', '<?= $datos->A_Quien_Se_Vendio ?>', '<?= $datos->Estado ?>', '<?= $datos->Creado_Por ?>', '<?= $datos->Fecha_Creacion ?>')">
            ...
            <div class="modal-body">
                <form id="formularioEditar" method="POST" action="#">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="A_Quien_Se_Vendio">Se le vendio a</label>
            ...
            <div class="modal-body">
                <form action="modelos/agregar_produccion_agricola_anterior.php" method="POST">
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <label for="A_Quien_Se_Vendio" class="form-label">Se le vendio a</label>
...
<script>
    ...
    function abrirModalEditar(Id_Produccion_Anterior, Precio_Venta, A_Quien_Se_Vendio, Estado) {
