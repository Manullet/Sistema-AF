<?php
session_start();
$_SESSION['url'] = 'vistas/Mantenimiento_apoyo_ext.php';
...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div>
            <h1 class="poppins-font mb-2">APOYO EXTERNO</h1>
            <br>
                ...
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ('<?= $datos->id_apoyo_ext  ?>', '<?= $datos->id_ficha ?>', '<?= $datos->id_productor ?>', '<?= $datos->recibe_apoyo_prodagrícola ?>',
...
<!-- Modal para editar Apoyop Ext -->
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #17A2B8;">
                <h5 class="poppins-modal mb-2" id="exampleModalLabel">EDITAR APOYO EXT</h5>
...
<!-- Modal para crear Apoyo Ext -->
<div class="modal fade" id="modalForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" role="document">
            <div class="modal-header" style="background-color: #17A2B8;">
                <h5 class="poppins-modal mb-2" id="exampleModalLabel">CREAR APOYO EXT </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<!-- JavaScript para manejar la edición de Apoyo Ext-->
<script>
    // Función para abrir el modal de edición
    function abrirModalEditar(id_apoyo_ext, id_ficha, id_productor, recibe_apoyo_prodagrícola, atencion_por_UAG, productos_vendidospor_pralesc, descripcion, estado) {
        document.getElementById("id_apoyo_ext").value = id_apoyo_ext;
        document.getElementById("id_ficha").value = id_ficha;
        document.getElementById("id_productor").value = id_productor;
        document.getElementById("recibe_apoyo_prodagrícola").value = recibe_apoyo_prodagrícola;
        document.getElementById("atencion_por_UAG").value = atencion_por_UAG;
        document.getElementById("productos_vendidospor_pralesc").value = productos_vendidospor_pralesc;
...
<!-- Script para mostrar el mensaje al momento de editar un Apoyo Ext-->
<script>
    $(document).ready(function() {
        $("#formularioEditar").on("submit", function(event) {
            ...
            $.ajax({
                url: "modelos/editar_apoyo_ext.php",
                method: "POST",
                data: $(this).serialize(),
                success: function(response) {
                    if (response == "success") {
                        Swal.fire({
                            title: "Apoyo externo actualizado correctamente",
                            text: "El Apoyo externo se ha actualizado correctamente.",
                            icon: "success",
                        ...
                        Swal.fire({
                            title: "Error",
                            text: "Hubo un problema al actualizar el Apoyo externo.",
                            icon: "error",
                            confirmButtonText: "Cerrar"
                        }).then(function() {
                            location.reload(); // Recarga la página
...
<!-- Script para mostrar el mensaje al momento de eliminar un Apoyo Ext-->
<script>
    $(document).ready(function() {
        $("form#deleteForm").on("submit", function(event) {
            ...
            Swal.fire({
                title: "¿Estás seguro?",
                text: "Esta acción eliminará el Apoyo externo. Esta acción no se puede deshacer.",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response == "success") {
                                Swal.fire({
                                    title: "Apoyo externo eliminado correctamente",
                                    text: "El Apoyo externo se ha eliminado correctamente.",
                                    icon: "success",
                                    showCancelButton: false,
                                    confirmButtonText: "Cerrar"
                                }).then(function() {
                                ...
                                Swal.fire({
                                    title: "Error",
                                    text: "Hubo un problema al eliminar el Apoyo externo.",
                                    icon: "error",
                                    confirmButtonText: "Cerrar"
                                }).then(function() {
                                    location.reload(); // Recarga la página
