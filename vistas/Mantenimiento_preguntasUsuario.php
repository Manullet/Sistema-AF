<?php 
session_start();
 $_SESSION['url'] = 'vistas/Mantenimiento_preguntasUsuario.php';
...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div>
            <h1 class="poppins-font mb-2">Preguntas de Seguridad de Usuario  <?php $id ?></h1>
            <br>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover">
            ...
            <tbody class="text-center">
                <?php
                include "../php/conexion_be.php";
                $sql = $conexion->query("SELECT pr.Id_pregunta, p.Pregunta, pr.Respuestas FROM preguntas_usuario pr
                INNER JOIN preguntas p ON p.Id_pregunta = pr.Id_pregunta
                WHERE pr.Id_Usuario = $usuario");
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        <td><?= $datos->Id_pregunta ?></td>
                        <td><?= $datos->Pregunta ?></td>
                        <td><?= $datos->Respuestas  ?></td>
                        
                        <td>

                           
                            <form id="deleteForm" method="POST" action="modelos/delete_pregUsuario.php" style="display: inline;">
    ...
    <div class="modal-dialog">
        <div class="modal-content" role="document">
            ...
            <div class="modal-body">
                <form action="modelos/agregar_pregUsuario.php" method="POST">
                        ...
                        <div class="col-8">
                            ...
                            <select class="form-control" id="Pregunta" name="Pregunta">
                                ...
                                <?php
                                    $sql = "SELECT Id_pregunta, Pregunta FROM preguntas where estado = 'A'";
...
<script>
    ...
    function abrirModalEditar(Id_pregunta, Pregunta, Respuesta) {
        document.getElementById("Id_pregunta").value = Id_pregunta;
        document.getElementById("PreguntaEdit").value = Pregunta;
        document.getElementById("RespuestaEdit").value = estado;
