...
<div class="containertable">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div>
            <h1 class="poppins-font mb-2">MANTENIMIENTO ETNIAS</h1>
            <br>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #17A2B8;">
                <h5 class="poppins-modal mb-2" id="exampleModalLabel">EDITAR ETNIA</h5>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="id_etnia">ID</label>
                                <input type="text" class="form-control" id="id_etnia" name="id_etnia" readonly>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
