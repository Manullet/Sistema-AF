    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover">
            ...
            <tbody class="text-center">
                ...
                $sql = $conexion->query("SELECT epp.id_ficha, p.primer_nombre AS nombre_productor, te.etnia AS nombre_etnia, epp.detalle_de_otros, epp.descripcion, epp.estado FROM tbl_etnias_por_productor epp JOIN tbl_etnias te ON epp.id_etnia = te.id_etnia JOIN tbl_productor p ON epp.id_productor = p.id_productor;");
                while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ('<?= $datos->id_ficha ?>','<?= $datos->nombre_etnia ?>', '<?= $datos->detalle_de_otros ?>', '<?= $datos->descripcion ?>', '<?= $datos->estado ?>')">
            ...
            <div class="modal-body">
                <form id="formularioEditar" method="POST" action="#">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="detalle_de_otros">Detalle</label>
                                <input type="text" class="form-control" id="detalle_de_otros" name="detalle_de_otros" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script>
    ...
    function abrirModalEditar(id_ficha, nombre_etnia, detalle_de_otros, descripcion, estado) {
        document.getElementById("id_ficha").value = id_ficha;
        document.getElementById("nombre_etnia").value = nombre_etnia;
