...
DELIMITER //
CREATE PROCEDURE `ActualizarApoyoActividadExterna`(IN `p_Id_Apoyo_Externo` BIGINT, IN `p_Id_Ficha` BIGINT, IN `p_Id_Productor` BIGINT, IN `p_Recibe_Apoyo_Produccion_Agricola` ENUM('S','N'), IN `p_Atencion_Por_UAG` ENUM('S','N'), IN `p_Productos_Vendidos_Por_Pralesc` ENUM('S','N'), IN `p_Descripcion` TEXT, IN `p_Modificado_Por` VARCHAR(255), IN `p_Nuevo_Estado` VARCHAR(50))
BEGIN
...
DELIMITER //
CREATE PROCEDURE `ActualizarBaseOrganizacion`(IN `p_Id_Pertenece_Organizacion` BIGINT, IN `p_Id_Ficha` BIGINT, IN `p_Id_Productor` BIGINT, IN `p_Pertenece_A_Organizacion` ENUM('S','N'), IN `p_Descripcion` TEXT, IN `p_Modificado_Por` VARCHAR(50), IN `p_Nuevo_Estado` ENUM('A','I'))
BEGIN
...
DELIMITER //
CREATE PROCEDURE `ActualizarEtniasPorProductor`(IN `p_Id_etnicidad` BIGINT, IN `p_id_ficha` BIGINT, IN `p_id_productor` BIGINT, IN `p_id_etnia` BIGINT, IN `p_detalle_de_otros` VARCHAR(255), IN `p_descripcion` TEXT, IN `p_modificado_por` VARCHAR(255), IN `p_estado` ENUM('A','I'))
BEGIN
...
DELIMITER //
CREATE PROCEDURE `ActualizarProductor`(IN `p_id_productor` BIGINT, IN `p_id_ficha` BIGINT, IN `p_primer_nombre` VARCHAR(255), IN `p_segundo_nombre` VARCHAR(255), IN `p_primer_apellido` VARCHAR(255), IN `p_segundo_apellido` VARCHAR(255), IN `p_identificacion` BIGINT, IN `p_fecha_nacimiento` DATE, IN `p_genero` VARCHAR(10), IN `p_estado_civil` VARCHAR(20), IN `p_nivel_escolaridad` VARCHAR(50), IN `p_ultimo_grado_escolar_aprobado` VARCHAR(50), IN `p_telefono_1` INT, IN `p_telefono_2` INT, IN `p_telefono_3` INT, IN `p_email_1` VARCHAR(255), IN `p_email_2` VARCHAR(255), IN `p_email_3` VARCHAR(255), IN `p_descripcion` TEXT, IN `p_modificado_por` BIGINT, IN `p_estado` ENUM('A','I'))
BEGIN
    DECLARE v_valid_productor BOOLEAN;
...
DELIMITER //
CREATE PROCEDURE `ActualizarRelevoOrganizacion`(IN `p_Id_Relevo` BIGINT, IN `p_id_ficha` BIGINT, IN `p_id_productor` BIGINT, IN `p_tendra_relevo` ENUM('S','N'), IN `p_cuantos_relevos` INT, IN `p_descripcion` TEXT, IN `p_modificado_por` VARCHAR(25), IN `p_estado` ENUM('A','I'))
BEGIN
    DECLARE v_valid_productor BOOLEAN;
...
DELIMITER //
CREATE PROCEDURE `ActualizarUbicacionProductor`(IN `p_id_ubicacion` BIGINT, IN `p_id_ficha` BIGINT, IN `p_id_productor` BIGINT, IN `p_id_departamento` BIGINT, IN `p_id_municipio` BIGINT, IN `p_id_aldea` BIGINT, IN `p_id_caserio` BIGINT, IN `p_ubicacion_geografica` VARCHAR(255), IN `p_distancia_parcela_vivienda` DECIMAL(10,2), IN `p_latitud_parcela` VARCHAR(20), IN `p_longitud_parcela` VARCHAR(20), IN `p_msnm` DECIMAL(10,2), IN `p_direccion_1` VARCHAR(255), IN `p_direccion_2` VARCHAR(255), IN `p_direccion_3` VARCHAR(255), IN `p_vive_en_finca` ENUM('S','N'), IN `p_nombre_finca` VARCHAR(255), IN `p_descripcion` TEXT, IN `p_modificado_por` VARCHAR(50), IN `p_estado` ENUM('A','I'))
BEGIN
    DECLARE v_valid_productor BOOLEAN;
...
-- Volcando datos para la tabla bd_af_p.bitacoras: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_af_p.fichas: ~1 rows (aproximadamente)
DELETE FROM `fichas`;
...
DELIMITER //
CREATE PROCEDURE `InsertarComposicion`(
	IN `p_id_ficha` INT,
	IN `p_id_productor` INT,
	IN `p_genero` ENUM('Hombre','Mujer'),
	IN `p_edad` VARCHAR(10),
	IN `p_cantidad` INT,
	IN `p_creado_por` VARCHAR(25)
)
BEGIN
...
CREATE PROCEDURE `InsertarFicha`(
	...
	IN `p_Anio_Solicitud` INT,
	IN `p_Descripcion` VARCHAR(255),
	IN `p_Creado_Por` VARCHAR(50),
	IN `p_Fecha_Entrevista` DATE,
	IN `p_Nombre_Encuentrador` VARCHAR(50),
	IN `p_Nombre_Encuestador` VARCHAR(50),
	IN `p_Nombre_Supervisor` VARCHAR(50)
)
BEGIN
    -- Utiliza CURRENT_TIMESTAMP para la fecha de creación y modificación
    INSERT INTO `fichas` (
...
DELIMITER //
CREATE PROCEDURE `InsertarProduccionComercializacion`(
	IN `p_Id_Ficha` BIGINT,
	IN `p_Id_Ubicacion` BIGINT,
	IN `p_Id_Productor` BIGINT,
	IN `p_Id_Tipo_Produccion` BIGINT,
	IN `p_Id_Medida_Produccion` BIGINT,
	IN `p_Cantidad_Vendida` DECIMAL(10,2),
	IN `p_Id_Medida_Venta` BIGINT,
	IN `p_Precio_Venta` DECIMAL(10,2),
	IN `p_A_Quien_Se_Vendio` VARCHAR(255),
...
DELIMITER //
CREATE PROCEDURE `InsertMigracionFamiliarData`(
	IN `p_id_ficha` INT,
	IN `p_id_productor` INT,
	IN `p_tiene_migrantes` ENUM('S','N'),
	IN `p_migracion_dentro_pais` ENUM('S','N'),
	IN `p_migracion_fuera_pais` ENUM('S','N'),
	IN `p_id_tipo_motivos` VARCHAR(255),
	IN `p_remesas` ENUM('S','N'),
	IN `p_creado_por` VARCHAR(50)
)
BEGIN
...
CREATE PROCEDURE `INSERTProduccion_AgrAnterior`(
	...
	IN `p_id_ficha` INT,
	IN `p_id_productor` INT,
	IN `p_Id_Tipo_Cultivo` BIGINT(20),
	IN `p_Superficie_Primera_Postrera` ENUM('Primera','Postrera'),
	IN `p_Id_Medida_Primera_Postrera` BIGINT(20),
	IN `p_Produccion_Obtenida` DECIMAL(10,2),
	IN `p_Id_Medida_Produccion_Obtenida` BIGINT(20),
	IN `p_Cantidad_Vendida` DECIMAL(10,2),
	IN `p_Id_Medida_Vendida` BIGINT(20),
	IN `p_Precio_Venta` DECIMAL(10,2),
	IN `p_A_Quien_Se_Vendio` VARCHAR(255),
	IN `p_Creado_Por` VARCHAR(255)
)
...
DELIMITER //
CREATE PROCEDURE `InsertRelevoData`(
	IN `p_id_ficha` INT,
	IN `p_id_productor` INT,
...
-- Volcando datos para la tabla bd_af_p.tbl_apoyos_produccion: ~0 rows (aproximadamente)
DELETE FROM `tbl_apoyos_produccion`;
...
-- Volcando datos para la tabla bd_af_p.tbl_base_organizacion: ~1 rows (aproximadamente)
DELETE FROM `tbl_base_organizacion`;
...
-- Volcando datos para la tabla bd_af_p.tbl_etnias_por_productor: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_af_p.tbl_ingreso_familiar: ~1 rows (aproximadamente)
DELETE FROM `tbl_ingreso_familiar`;
...
-- Volcando datos para la tabla bd_af_p.tbl_manejo_riego: ~0 rows (aproximadamente)
DELETE FROM `tbl_manejo_riego`;
...
-- Volcando datos para la tabla bd_af_p.tbl_migracion_familiar: ~1 rows (aproximadamente)
DELETE FROM `tbl_migracion_familiar`;
...
-- Volcando datos para la tabla bd_af_p.tbl_motivos_no_creditos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_af_p.tbl_practicas_por_produccion: ~3 rows (aproximadamente)
DELETE FROM `tbl_practicas_por_produccion`;
...
-- Volcando datos para la tabla bd_af_p.tbl_produccion_agricola_anterior: ~1 rows (aproximadamente)
DELETE FROM `tbl_produccion_agricola_anterior`;
...
-- Volcando datos para la tabla bd_af_p.tbl_produccion_comercializacion: ~1 rows (aproximadamente)
DELETE FROM `tbl_produccion_comercializacion`;
...
INSERT INTO `tbl_produccion_pecuaria` (`Id_Produccion_Pecuaria`, `Id_Ficha`, `Id_Ubicacion`, `Id_Productor`, `Año_Produccion`, `Id_Tipo_Pecuario`, `Cantidad_Hembras`, `Cantidad_Machos`, `Cantidad_Total`, `Descripcion_Otros`, `Precio_Venta`, `Id_Medida_Venta`, `Cantidad_Mercado`, `Descripcion`, `Creado_Por`, `Fecha_Creacion`, `Modificado_Por`, `Fecha_Modificacion`, `Estado`) VALUES
	(1, 1, 1, 1, 0, 2, 0, 2, 2, NULL, 1111.00, 2, 213, NULL, 'HARU', '2024-03-21 03:31:01', NULL, '2024-03-21 03:31:01', 'A'),
	(2, 1, 1, 1, 0, 4, 1, 0, 1, NULL, 1111.00, 2, 213, NULL, 'HARU', '2024-03-21 03:31:01', NULL, '2024-03-21 03:31:01', 'A');
...
-- Volcando datos para la tabla bd_af_p.tbl_productor: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_af_p.tbl_productor_actividad_externa: ~1 rows (aproximadamente)
DELETE FROM `tbl_productor_actividad_externa`;
...
-- Volcando datos para la tabla bd_af_p.tbl_relevo_organizacion: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_af_p.tbl_toma_decisiones: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_af_p.tbl_ubicacion_productor: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_af_p.tbl_unidad_productora: ~1 rows (aproximadamente)
...
CREATE PROCEDURE `TempInsertarUnidadProductoraYRiego`(
	...
	IN `p_Superficie_Produccion` DECIMAL(10,2),
...
DELIMITER //
CREATE PROCEDURE `Temp_Insertar_Ubicacion_Productor`(
	IN `p_id_ficha` INT,
	IN `p_id_productor` INT,
	IN `p_Id_Departamento` BIGINT,
	IN `p_Id_Municipio` BIGINT,
	IN `p_Id_Aldea` BIGINT,
	IN `p_Id_Cacerio` BIGINT,
